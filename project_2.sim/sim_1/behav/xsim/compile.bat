...
REM
REM Generated by Vivado on Wed Sep 24 17:15:21 -0400 2025
...
echo "xvhdl --incr --relax -prj ALU_tbench_vhdl.prj"
call xvhdl  --incr --relax -prj ALU_tbench_vhdl.prj -log xvhdl.log
